...
import com.kevalpatel2106.emoticompack.*;
...
public class MainActivity extends AppCompatActivity {
    ...
    private android.support.v7.widget.AppCompatImageView emoji_open_close_btn;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       textView.setEmoticonProvider(SamsungEmoticonProvider.create());
        ...
        final EmoticonGIFKeyboardFragment.EmoticonConfig emoticonConfig = new EmoticonGIFKeyboardFragment.EmoticonConfig()
